...
export default function Home() {
    return (
        <div>
            <Head>
                <title>MedBook - Homepage</title>
                <meta name="description" content="MedBook - Homepage" />
            ...
            <div className="overflow-x-hidden antialiased">
                ...
                <Header />
                {/* <!-- BEGIN MAIN SECTION --> */}
                <div className="relative items-center justify-center w-full overflow-x-hidden lg:pt-20 lg:pb-16 xl:pt-30 xl:pb-24 shadow-sm">
                    <div className="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
                        <div className="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
                            <h1 className="relative mb-4 text-3xl font-black leading-tight text-dark sm:text-6xl xl:mb-8">
                                Decentralized Medical Health Records
                            </h1>
                            <p className="pr-0 mb-8 text-base text-grey sm:text-lg xl:text-xl lg:pr-20">
                        ...
                        <div className="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
                            <div className="container relative left-0 w-full max-w-4xl lg:absolute lg:w-screen">
                                <img
                                    src="/home.png"
                                    className="mt-8 w-auto h-auto rounded-lg lg:w-3/4 lg:h-3/4 lg:mt-16"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div
                    id="features"
                    className="relative w-full px-8 py-8 md:py-12 lg:py-16 xl:py-24 xl:px-0"
                >
                    <div className="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
                        <h2 className="my-5 text-base font-medium tracking-tight text-green uppercase">
                            Features
                        </h2>
                        <h3 className="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-dark sm:mt-0 sm:px-0 sm:text-6xl">
