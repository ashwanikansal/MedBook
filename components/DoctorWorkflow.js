    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-blue-light text-indigo-500 flex-shrink-0">
                        <svg
                            ...
                            strokeWidth="2"
                            className="sm:w-16 sm:h-16 w-10 h-10 text-blue-dark"
                            viewBox="0 0 24 24"
                        >
                ...
                <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-colv">
                    <div className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-blue-light text-indigo-500 flex-shrink-0">
                        <svg
                            fill="none"
                            stroke="currentColor"
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            className="sm:w-16 sm:h-16 w-10 h-10 text-pink"
                            viewBox="0 0 24 24"
                        >
