export default function Footer() {
    return (
        <div>
            <footer className="px-4 pt-20 pb-8 text-light bg-light border-t border-grey">
                <div className="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
                    <div className="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                        ...
                        <p className="mt-6 mr-4 text-base text-grey">
                    ...
                    <div className="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                        <ul className="flex flex-col w-full p-0 font-medium text-left text-grey list-none">
                            <li className="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-grey uppercase md:mt-0">
                                About Project
                            </li>
                            <li>
                                <a
                                    href="#"
                                    target="_blank"
                                    className="inline-block px-3 py-2 text-grey no-underline hover:text-dark"
                                >
                                    Coming Soon
                                </a>
                            </li>
