...
const frontEndContractsFile =
  "../next-js-medbook/constants/networkMapping.json";
const frontEndAbiLocation = "../next-js-medbook/constants/";
...
async function updateAbi() {
  const patientMedicalRecordSystem = await ethers.getContract(
...
async function updateContractAddresses() {
  ...
  if (chainId in contractAddress) {
    ...
    contractAddress[chainId] = {
      PatientMedicalRecordSystem: [patientMedicalRecordSystem.address],
    };
  }
